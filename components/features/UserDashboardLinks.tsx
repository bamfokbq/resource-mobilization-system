...
import { AlertCircle, CheckCircle2, Loader2, Home, FileText, Settings, LogOut, User } from 'lucide-react'
...
interface UserDashboardLinksProps {
                ...
                <ul className='flex flex-col gap-2 w-full' role="menubar">
                    {navigationItems.map((item) => {
                        const isActive = pathname === item.path ||
                            (item.path === '/dashboard/surveys' && pathname.startsWith('/dashboard/surveys/form'))
