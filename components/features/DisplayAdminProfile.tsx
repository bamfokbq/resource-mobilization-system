        ...
        {!isEditing ? (
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-orange-500 rounded-xl">
                    <FiMail className="h-5 w-5 text-white" />
                  </div>
                  <div>
                    <p className="text-sm text-orange-600 font-medium">Email Address</p>
                    <p className="text-orange-900 font-semibold">{email || 'No email provided'}</p>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-r from-red-50 to-red-100 border border-red-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-red-900 font-semibold">{telephone || 'No phone provided'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Bio Section */}
            <div className="bg-gradient-to-r from-amber-50 to-amber-100 border border-amber-200 rounded-xl p-6 hover:shadow-md transition-all duration-300">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 bg-amber-500 rounded-xl">
                  <MdOutlineBiotech className="h-5 w-5 text-white" />
                </div>
                <h3 className="text-lg font-bold text-amber-900">Biography</h3>
              </div>
              <p className="text-amber-800 leading-relaxed">{bio || defaultBio}</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 border border-emerald-200 rounded-xl p-4 text-center hover:shadow-md transition-all duration-300">
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-emerald-700 font-bold text-lg">Verified Administrator</span>
              </div>
            </div>
          </div>) : (
          // Edit Mode
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-blue-600 font-medium mb-2">First Name</p>
                      <input
                        {...register("firstName", { required: "First name is required" })}
                        defaultValue={firstName}
                        className="w-full px-3 py-2 rounded-lg border border-blue-300 focus:border-blue-500 focus:outline-none bg-white shadow-sm"
                ...
                <div className="bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-purple-600 font-medium mb-2">Last Name</p>
                      <input
                        {...register("lastName", { required: "Last name is required" })}
                        defaultValue={lastName}
                        className="w-full px-3 py-2 rounded-lg border border-purple-300 focus:border-purple-500 focus:outline-none bg-white shadow-sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 rounded-lg border border-red-300 focus:border-red-500 focus:outline-none bg-white shadow-sm"
                ...
                <div className="bg-gradient-to-r from-amber-50 to-amber-100 border border-amber-200 rounded-xl p-6">
                  ...
                  <textarea
                    {...register("bio")}
                    defaultValue={bio}
                    className="w-full px-4 py-3 rounded-lg border border-amber-300 focus:border-amber-500 focus:outline-none resize-none bg-white shadow-sm"
                    rows={4}
                ...
                <div className="flex gap-4 justify-end pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-xl hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 font-medium flex items-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
